...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&size=22&duration=3000&pause=1000&color=58A6FF&center=true&vCenter=true&width=900&lines=Building+Low-Latency+Systems;Designing+Quantitative+Research+Infrastructure;Engineering+ML+Pipelines+%26+Backend+Architectures;Async+Systems+%7C+Trading+Engines+%7C+Distributed+Thinking" />
...
class AbhinavSaha {
public:
    string focus = "Systems Engineering & Quant Research";
    ...
    void currentlyBuilding() {
        cout << "Trading systems, async pipelines, ML infra & intelligent tooling";
    }
};
```
...
|---|---|
| ⚡ Systems | Event-driven architectures, concurrency, low-latency design |
